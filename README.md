...
| 订阅页没有变化 / 没有二维码 | 在 **VPS 上**执行（带时间戳防 CDN 缓存）：`curl -fsSL "https://raw.githubusercontent.com/CNLiuBei/stable-proxy-stack/main/scripts/refresh-panel.sh?t=$(date +%s)" -o /tmp/rp.sh && bash /tmp/rp.sh` |
